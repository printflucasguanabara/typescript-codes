...
let frutas: string[] = ["maçã", "banana", "cereja", "tâmara", "sabugueiro"];
...
let comprimentoPush = frutas.push("pêssego");
...
let elementoShift = frutas.shift();
...
let comprimentoUnshift = frutas.unshift("damasco");
...
let arraySlice: string[] = frutas.slice(1, 3);
